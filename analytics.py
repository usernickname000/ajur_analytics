...
ACCOUNTING_ROWS = [
    ...
    ('IC Доходы КС ФОНТАНКА',                 []),  # внешний — появилась в Доходы_2026.xlsx
...
ACCOUNTING_BLOCKS = {
    ...
    'Total Events Sales': [
        ...
        'IC Доходы ЭВЕНТЫ', 'Мероприятия КС ФОНТАНКА', 'IC Доходы КС ФОНТАНКА',
        'Мероприятия КС Медицина ДОКТОР',
    ],
    'Total Прочие доходы': [
